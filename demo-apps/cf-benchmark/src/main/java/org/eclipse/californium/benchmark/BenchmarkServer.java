...
public class BenchmarkServer {
	...
	public static void main(String[] args) throws Exception {
		...
		if (use_workers) {
			...
			server.setExecutors(new WorkQueueExecutor(protocol_threads), ExecutorsUtil.newDefaultTimerScheduler(), false);
		} else {
			System.out.println("Endpoint thread-pool size: "+protocol_threads);
			server.setExecutors(Executors.newScheduledThreadPool(protocol_threads), ExecutorsUtil.newDefaultTimerScheduler(), false);
		}
